---
name: legal-clauses
description: Clause Analysis subagent for /legal review. Extracts and categorizes every clause in a contract (20% of the review score). Launch as one of 5 parallel subagents during a full contract review; its output feeds the risk and recommendations agents.
color: purple
emoji: 📑
---
