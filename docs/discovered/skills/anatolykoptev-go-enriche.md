---
title: "anatolykoptev/go-enriche — Claude Code skill discovered by cue"
description: "Claude Code skill from anatolykoptev/go-enriche"
layout: page
updated: 2026-07-03
tags: [claude-code, skill, core]
---

# ✨ [anatolykoptev/go-enriche](https://github.com/anatolykoptev/go-enriche)

**★ 0** · strong (score 6.5) · Go · data-enrichment, go, golang, mcp, mcp-server
...
- 🏷️ Tags: data-enrichment, go, golang, mcp, mcp-server
...
cue skills add anatolykoptev/go-enriche --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/anatolykoptev/go-enriche)
