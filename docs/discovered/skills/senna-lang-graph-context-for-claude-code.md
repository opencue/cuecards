...
**★ 2** · strong (score 6.3) · TypeScript · claude-code, ide-integration, obsidian, obsidian-plugin
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/senna-lang/graph-context-for-claude-code)
