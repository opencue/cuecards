---
title: "farmost-beep/social-agent — Claude Code skill discovered by cue"
...
# 💎 [farmost-beep/social-agent](https://github.com/farmost-beep/social-agent)

**★ 0** · exceptional (score 13) · Python · ai-assistant, claude-code, claude-code-skill, social-relationship, wechat
...
- 🏷️ Tags: ai-assistant, claude-code, claude-code-skill, social-relationship, wechat
...
cue skills add farmost-beep/social-agent --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/farmost-beep/social-agent)
