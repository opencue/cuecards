---
title: "kiliankoe/opendata-dresden — Claude Code skill discovered by cue"
description: "Website, CLI, and MCP server for exploring Dresden's open data sources"
layout: page
updated: 2026-09-17
tags: [claude-code, skill, core]
---

# ✨ [kiliankoe/opendata-dresden](https://github.com/kiliankoe/opendata-dresden)

**★ 1** · strong (score 7.8) · Go · cli, cli-tool, dresden, mcp-server, opendata

> Website, CLI, and MCP server for exploring Dresden's open data sources
...
- 🏷️ Tags: cli, cli-tool, dresden, mcp-server, opendata
...
cue skills add kiliankoe/opendata-dresden --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/kiliankoe/opendata-dresden)
