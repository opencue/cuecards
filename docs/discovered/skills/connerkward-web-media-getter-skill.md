---
title: "connerkward/web-media-getter-skill — Claude Code skill discovered by cue"
description: "web-media-getter — a Claude Code skill: one query across free image/video/GIF APIs, license-tagged results."
layout: page
updated: 2026-06-17
...
- 🏷️ Tags: agent-skills, ai-tools, anthropic, claude-code, claude-code-plugin, claude-code-skill, claude-skill, images, media-api, stock-media, video
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/connerkward/web-media-getter-skill)
