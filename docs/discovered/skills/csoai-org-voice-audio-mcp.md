---
title: "CSOAI-ORG/voice-audio-mcp — Claude Code skill discovered by cue"
description: "MEOK AI Labs — Voice & Audio. TTS, voice cloning, audio generation, transcription. Integrates with Kokoro TTS and Whisper STT."
layout: page
updated: 2026-06-13
tags: [claude-code, skill, core]
---

# ✨ [CSOAI-ORG/voice-audio-mcp](https://github.com/CSOAI-ORG/voice-audio-mcp)

**★ 1** · strong (score 6.3) · Python · ai-agents, ai-governance, claude, mcp, mcp-server
...
cue skills add CSOAI-ORG/voice-audio-mcp --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/CSOAI-ORG/voice-audio-mcp)
