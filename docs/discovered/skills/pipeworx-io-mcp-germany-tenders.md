---
title: "pipeworx-io/mcp-germany-tenders — Claude Code skill discovered by cue"
description: "Germany public procurement MCP — official German government tenders (keyless)."
layout: page
updated: 2026-08-04
tags: [claude-code, skill, core]
---

# ✨ [pipeworx-io/mcp-germany-tenders](https://github.com/pipeworx-io/mcp-germany-tenders)

**★ 0** · strong (score 6) · TypeScript · germany-tenders, mcp, mcp-server, model-context-protocol, pipeworx
...
- 🏷️ Tags: germany-tenders, mcp, mcp-server, model-context-protocol, pipeworx
...
cue skills add pipeworx-io/mcp-germany-tenders --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/pipeworx-io/mcp-germany-tenders)
