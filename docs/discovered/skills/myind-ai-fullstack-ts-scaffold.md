---
title: "myind-ai/fullstack-ts-scaffold — Claude Code skill discovered by cue"
...
- 🏷️ Tags: boilerplate, claude-code, claude-skill, express, fullstack, monorepo, nextjs, scaffold, typescript
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/myind-ai/fullstack-ts-scaffold)
