---
title: "TurtleTech-ehf/ookcite-mcp — Claude Code skill discovered by cue"
description: "MCP server for OokCite citation validation and formatting"
layout: page
updated: 2026-09-20
tags: [claude-code, skill, core]
---

# 💎 [TurtleTech-ehf/ookcite-mcp](https://github.com/TurtleTech-ehf/ookcite-mcp)

**★ 2** · exceptional (score 8) · Rust · citations, mcp, mcp-server
...
- 🏷️ Tags: citations, mcp, mcp-server
...
cue skills add TurtleTech-ehf/ookcite-mcp --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/TurtleTech-ehf/ookcite-mcp)
