---
title: "MachuraHarry/pipe — Claude Code skill discovered by cue"
description: "The first language with built-in MCP (server + client). Semantic Pipeline Runtime: 198 builtins, AI pipelines, sandboxed agents, single ~7 MB binary, zero depen"
layout: page
updated: 2026-08-14
...
**★ 2** · strong (score 6.5) · Go · ai, ai-agents, devtools, golang, llm
...
- 🏷️ Tags: ai, ai-agents, devtools, golang, llm, mcp, mcp-server, model-context-protocol, pipeline, spr
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/MachuraHarry/pipe)
