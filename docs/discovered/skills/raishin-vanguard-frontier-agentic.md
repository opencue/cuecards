...
**★ 18** · exceptional (score 10.5) · Python · agent-skills, ai-agents-framework, asia-cloud-provider, azure, claude-code-skill
...
cue skills add Raishin/vanguard-frontier-agentic --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/Raishin/vanguard-frontier-agentic)
