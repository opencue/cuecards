---
title: "wishmatic/neo-mcp — Claude Code skill discovered by cue"
description: "A thin MCP wrapper around a local Stable Diffusion WebUI (Forge Neo) instance"
layout: page
updated: 2026-09-17
tags: [claude-code, skill, core]
---

# ✨ [wishmatic/neo-mcp](https://github.com/wishmatic/neo-mcp)

**★ 0** · strong (score 6) · Go · forge-neo, image-generation, mcp-server
...
- 🏷️ Tags: forge-neo, image-generation, mcp-server
...
cue skills add wishmatic/neo-mcp --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/wishmatic/neo-mcp)
