---
title: "pipeworx-io/mcp-giantbomb — Claude Code skill discovered by cue"
description: "Giant Bomb video-game catalog (free key)"
layout: page
updated: 2026-08-04
tags: [claude-code, skill, core]
---

# ✨ [pipeworx-io/mcp-giantbomb](https://github.com/pipeworx-io/mcp-giantbomb)

**★ 0** · strong (score 6) · TypeScript · giantbomb, mcp, mcp-server, model-context-protocol, pipeworx
...
- 🏷️ Tags: giantbomb, mcp, mcp-server, model-context-protocol, pipeworx
...
cue skills add pipeworx-io/mcp-giantbomb --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/pipeworx-io/mcp-giantbomb)
