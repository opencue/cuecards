---
title: "locoda/duizuo-reading-companion-skill — Claude Code skill discovered by cue"
description: "对坐 · 阅读陪伴 · 陪一个人读完一本书。开读前教他怎么读，开读后只聊他读到的部分，一个字都不剧透。"
layout: page
updated: 2026-09-20
...
**★ 0** · strong (score 6.5) · Python · ai-agent-skill, ai-agent-skills, anti-spoiler, chinese, reading-assistant
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/locoda/duizuo-reading-companion-skill)
