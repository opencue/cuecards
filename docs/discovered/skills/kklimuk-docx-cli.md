---
title: "kklimuk/docx-cli — Claude Code skill discovered by cue"
...
# 💎 [kklimuk/docx-cli](https://github.com/kklimuk/docx-cli)

**★ 125** · exceptional (score 13.9) · TypeScript · agent-skills, ai-agents, anthropic-skills, claude-code, claude-skill
...
- 🏷️ Tags: agent-skills, ai-agents, anthropic-skills, claude-code, claude-skill, cli, codex, docx, ooxml, word
...
cue skills add kklimuk/docx-cli --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/kklimuk/docx-cli)
