---
title: "pipeworx-io/mcp-geodistance — Claude Code skill discovered by cue"
description: "Geographic coordinate math MCP."
layout: page
updated: 2026-08-04
tags: [claude-code, skill, core]
---

# ✨ [pipeworx-io/mcp-geodistance](https://github.com/pipeworx-io/mcp-geodistance)

**★ 0** · strong (score 5) · TypeScript · geodistance, mcp, mcp-server, model-context-protocol, pipeworx
...
- 🏷️ Tags: geodistance, mcp, mcp-server, model-context-protocol, pipeworx
...
cue skills add pipeworx-io/mcp-geodistance --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/pipeworx-io/mcp-geodistance)
