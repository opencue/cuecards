---
title: "CSOAI-ORG/url-ai-mcp — Claude Code skill discovered by cue"
...
# ✨ [CSOAI-ORG/url-ai-mcp](https://github.com/CSOAI-ORG/url-ai-mcp)
...
cue skills add CSOAI-ORG/url-ai-mcp --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/CSOAI-ORG/url-ai-mcp)
