---
title: "CSOAI-ORG/summarizer-ai-mcp — Claude Code skill discovered by cue"
description: "Text summarization and extraction by MEOK AI Labs."
layout: page
updated: 2026-06-13
tags: [claude-code, skill, core]
---

# ✨ [CSOAI-ORG/summarizer-ai-mcp](https://github.com/CSOAI-ORG/summarizer-ai-mcp)
...
cue skills add CSOAI-ORG/summarizer-ai-mcp --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/CSOAI-ORG/summarizer-ai-mcp)
