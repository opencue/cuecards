---
title: "financial-reports/financial-reports-mcp-server — Claude Code skill discovered by cue"
description: "Official Model Context Protocol (MCP) server for the FinancialReports API. Provides LLM-native access to European company filings and financial data."
layout: page
updated: 2026-09-16
...
**★ 2** · exceptional (score 8) · Python · filing, filings, finance, fundamental-analysis, mcp
...
- 🏷️ Tags: filing, filings, finance, fundamental-analysis, mcp, mcp-server, stocks, stocks-api, trading
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/financial-reports/financial-reports-mcp-server)
