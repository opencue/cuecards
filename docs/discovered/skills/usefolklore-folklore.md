...
**★ 1** · exceptional (score 8.8) · TypeScript · ai-agents, beir, claude-code, codex, did-key
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/usefolklore/folklore)
