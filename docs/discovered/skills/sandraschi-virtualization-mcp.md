---
title: "sandraschi/virtualization-mcp — Claude Code skill discovered by cue"
description: "MCP Server and Webapp for VirtualBox, Hyper-V and Windows sandbox.  VM operations, networking, storage, snapshots, and security features."
layout: page
updated: 2026-08-31
tags: [claude-code, skill, core]
---

# 💎 [sandraschi/virtualization-mcp](https://github.com/sandraschi/virtualization-mcp)

**★ 14** · exceptional (score 9.2) · Python · hyper-v, mcp-server, sandbox, virtual-box, virtualization
...
- 🏷️ Tags: hyper-v, mcp-server, sandbox, virtual-box, virtualization, webapp
...
cue skills add sandraschi/virtualization-mcp --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/sandraschi/virtualization-mcp)
