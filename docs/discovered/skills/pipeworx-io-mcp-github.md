---
title: "pipeworx-io/mcp-github — Claude Code skill discovered by cue"
description: "MCP server for GitHub — search repos, get details, list issues, and look up user profiles"
layout: page
updated: 2026-08-04
tags: [claude-code, skill, core]
---

# ✨ [pipeworx-io/mcp-github](https://github.com/pipeworx-io/mcp-github)

**★ 0** · strong (score 7.5) · TypeScript · github, mcp, mcp-server, model-context-protocol, pipeworx
...
- 🏷️ Tags: github, mcp, mcp-server, model-context-protocol, pipeworx
...
cue skills add pipeworx-io/mcp-github --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/pipeworx-io/mcp-github)
