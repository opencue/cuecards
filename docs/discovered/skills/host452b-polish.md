...
# 💎 [host452b/polish](https://github.com/host452b/polish)

**★ 0** · exceptional (score 8) · Python · agent-skills, ai, chain-of-thought, claude, claude-code
...
cue skills add host452b/polish --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/host452b/polish)
