...
cue skills add richardwooding/file-search-on --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/richardwooding/file-search-on)
