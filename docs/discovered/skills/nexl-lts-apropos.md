...
# 🔹 [NEXL-LTS/apropos](https://github.com/NEXL-LTS/apropos)
...
cue skills add NEXL-LTS/apropos --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/NEXL-LTS/apropos)
