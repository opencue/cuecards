...
# 💎 [Pippit-dev/cli](https://github.com/Pippit-dev/cli)

**★ 9** · exceptional (score 9.9) · JavaScript · claude-code-skill, claude-skills
...
cue skills add Pippit-dev/cli --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/Pippit-dev/cli)
