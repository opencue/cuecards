---
title: "CSOAI-ORG/clinical-trials-ai-mcp — Claude Code skill discovered by cue"
...
**★ 0** · strong (score 7.5) · Python · ai, ai-governance, compliance, csoai, mcp
...
- 🏷️ Tags: ai, ai-governance, compliance, csoai, mcp, mcp-server, model-context-protocol
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/CSOAI-ORG/clinical-trials-ai-mcp)
