---
title: "SpekoAI/mcp — Claude Code skill discovered by cue"
description: "Hosted MCP server for Speko - manage voice AI agents, sessions, and calls from Claude Code, Cursor, and any MCP client"
layout: page
updated: 2026-09-17
tags: [claude-code, skill, core]
---

# ✨ [SpekoAI/mcp](https://github.com/SpekoAI/mcp)

**★ 0** · strong (score 7.5) · Python · claude, mcp, mcp-server, speech-to-text, stt
...
- 🏷️ Tags: claude, mcp, mcp-server, speech-to-text, stt, text-to-speech, tts, voice-agents, voice-ai
...
cue skills add SpekoAI/mcp --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/SpekoAI/mcp)
