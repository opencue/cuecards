---
title: "CSOAI-ORG/tone-rewriter-ai-mcp — Claude Code skill discovered by cue"
description: "Text tone analysis and rewriting. Analyze, transform, and match text tone for professional, casual, formal, and other styles. By MEOK AI Labs."
layout: page
updated: 2026-06-13
tags: [claude-code, skill, core]
---

# ✨ [CSOAI-ORG/tone-rewriter-ai-mcp](https://github.com/CSOAI-ORG/tone-rewriter-ai-mcp)
...
cue skills add CSOAI-ORG/tone-rewriter-ai-mcp --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/CSOAI-ORG/tone-rewriter-ai-mcp)
