---
title: "CSOAI-ORG/skip-hire-ai-mcp — Claude Code skill discovered by cue"
...
# ✨ [CSOAI-ORG/skip-hire-ai-mcp](https://github.com/CSOAI-ORG/skip-hire-ai-mcp)

**★ 0** · strong (score 6) · Python · ai-agents, ai-compliance, claude, mcp, mcp-server
...
- 🏷️ Tags: ai-agents, ai-compliance, claude, mcp, mcp-server, meok, meok-ai-labs, mit-license, model-context-protocol, open-source, uk-trade, waste-management
...
cue skills add CSOAI-ORG/skip-hire-ai-mcp --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/CSOAI-ORG/skip-hire-ai-mcp)
