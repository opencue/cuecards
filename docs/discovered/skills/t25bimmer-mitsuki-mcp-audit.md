---
title: "T25bimmer/mitsuki-mcp-audit — Claude Code skill discovered by cue"
description: "🔍 Enable efficient security audits for npm dependencies with Mitsuki-MCP-audit, offering key insights in standardized formats for local and remote projects."
layout: page
updated: 2026-06-24
...
**★ 1** · strong (score 7.8) · docker, ejs, git-api, mcp, mcp-server
...
- 🏷️ Tags: docker, ejs, git-api, mcp, mcp-server, monorepo, nodejs, rollup, semver, typescript, zod
...
cue skills add T25bimmer/mitsuki-mcp-audit --profile backend
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/T25bimmer/mitsuki-mcp-audit)
