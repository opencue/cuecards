---
title: "pipeworx-io/mcp-gmail — Claude Code skill discovered by cue"
description: "Gmail MCP Pack"
layout: page
updated: 2026-08-04
tags: [claude-code, skill, core]
---

# ✨ [pipeworx-io/mcp-gmail](https://github.com/pipeworx-io/mcp-gmail)

**★ 0** · strong (score 6.5) · TypeScript · gmail, mcp, mcp-server, model-context-protocol, pipeworx
...
- 🏷️ Tags: gmail, mcp, mcp-server, model-context-protocol, pipeworx
...
cue skills add pipeworx-io/mcp-gmail --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/pipeworx-io/mcp-gmail)
