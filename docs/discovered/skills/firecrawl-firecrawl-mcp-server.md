---
title: "firecrawl/firecrawl-mcp-server — Claude Code skill discovered by cue"
...
**★ 7043** · exceptional (score 17) · JavaScript · batch-processing, claude, content-extraction, data-collection, firecrawl
...
- 🏷️ Tags: batch-processing, claude, content-extraction, data-collection, firecrawl, firecrawl-ai, javascript-rendering, llm-tools, mcp, mcp-server, model-context-protocol, search-api, web-crawler, web-scraping
...
cue skills add firecrawl/firecrawl-mcp-server --profile backend
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/firecrawl/firecrawl-mcp-server)
