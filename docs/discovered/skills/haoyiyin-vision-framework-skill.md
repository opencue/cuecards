...
**★ 0** · exceptional (score 14.5) · Swift · agent-skill, ai-agent, ai-agent-skill, claude-code, computer-vision
...
cue skills add haoyiyin/vision-framework-skill --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/haoyiyin/vision-framework-skill)
