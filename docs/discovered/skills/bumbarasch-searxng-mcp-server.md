---
title: "bumbaRasch/searxng-mcp-server — Claude Code skill discovered by cue"
description: "MCP server for a self-hosted SearXNG instance: web, image, news, video and music search plus page fetch."
layout: page
updated: 2026-09-20
tags: [claude-code, skill, core]
---

# ✨ [bumbaRasch/searxng-mcp-server](https://github.com/bumbaRasch/searxng-mcp-server)

**★ 0** · strong (score 6) · TypeScript · mcp, mcp-server, model-context-protocol, privacy, search
...
- 🏷️ Tags: mcp, mcp-server, model-context-protocol, privacy, search, searxng, self-hosted, typescript
...
cue skills add bumbaRasch/searxng-mcp-server --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/bumbaRasch/searxng-mcp-server)
