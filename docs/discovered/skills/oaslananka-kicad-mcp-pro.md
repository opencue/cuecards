---
title: "oaslananka/kicad-mcp-pro — Claude Code skill discovered by cue"
description: "AI-ready MCP server for KiCad: automate schematic, PCB, ERC/DRC, DFM, BOM and manufacturing review from Claude, Cursor, Copilot and other AI agents."
layout: page
updated: 2026-08-02
...
**★ 41** · exceptional (score 11.2) · Python · ai-agent, bom, claude, dfm, drc
...
- 🏷️ Tags: ai-agent, bom, claude, dfm, drc, eda, eda-automation, electronics, erc, gerber-export, kicad, kicad-plugin, llm, manufacturing, mcp-server, model-context-protocol, pcb-design, python, schematic, simulation
...
cue skills add oaslananka/kicad-mcp-pro --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/oaslananka/kicad-mcp-pro)
