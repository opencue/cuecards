...
cue skills add connerkward/macos-screen-recorder-system-audio --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/connerkward/macos-screen-recorder-system-audio)
