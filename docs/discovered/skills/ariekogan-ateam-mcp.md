---
title: "ariekogan/ateam-mcp — Claude Code skill discovered by cue"
...
**★ 1** · strong (score 7.8) · JavaScript · adas, ai-agents, mcp, mcp-server, model-context-protocol
...
- 🏷️ Tags: adas, ai-agents, mcp, mcp-server, model-context-protocol, multi-agent
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/ariekogan/ateam-mcp)
