---
title: "sandraschi/games-dash — Claude Code skill discovered by cue"
description: "Web-based games collection with 100+ games and AI opponents"
layout: page
updated: 2026-07-06
tags: [claude-code, skill, core]
---

# ✨ [sandraschi/games-dash](https://github.com/sandraschi/games-dash)

**★ 1** · strong (score 7.8) · HTML · games, games-ai, katago, mcp-server, openspiel

> Web-based games collection with 100+ games and AI opponents
...
- 🏷️ Tags: games, games-ai, katago, mcp-server, openspiel, stockfish, webapp, yaneuraou
...
cue skills add sandraschi/games-dash --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/sandraschi/games-dash)
