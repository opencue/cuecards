---
title: "CSOAI-ORG/subscription-tracker-ai-mcp — Claude Code skill discovered by cue"
...
# ✨ [CSOAI-ORG/subscription-tracker-ai-mcp](https://github.com/CSOAI-ORG/subscription-tracker-ai-mcp)
...
cue skills add CSOAI-ORG/subscription-tracker-ai-mcp --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/CSOAI-ORG/subscription-tracker-ai-mcp)
