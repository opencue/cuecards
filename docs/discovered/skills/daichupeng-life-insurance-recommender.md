---
title: "daichupeng/life-insurance-recommender — Claude Code skill discovered by cue"
description: "Recommend life insurance policy for users in Singapore"
layout: page
updated: 2026-07-13
tags: [claude-code, skill, core]
---

# 💎 [daichupeng/life-insurance-recommender](https://github.com/daichupeng/life-insurance-recommender)

**★ 0** · exceptional (score 13) · HTML · claude-code-skill, claude-skill, claude-skills
...
- 🏷️ Tags: claude-code-skill, claude-skill, claude-skills
...
cue skills add daichupeng/life-insurance-recommender --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/daichupeng/life-insurance-recommender)
