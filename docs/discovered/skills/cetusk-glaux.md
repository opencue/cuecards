---
title: "cetusk/Glaux — Claude Code skill discovered by cue"
description: "A Lightweight DAW for Making Music with AI"
layout: page
updated: 2026-09-26
...
**★ 0** · strong (score 6) · Rust · daw, mcp-server, rust, svelte5, tauri
...
- 🏷️ Tags: daw, mcp-server, rust, svelte5, tauri
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/cetusk/Glaux)
