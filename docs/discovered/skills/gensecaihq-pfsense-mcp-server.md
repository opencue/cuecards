---
title: "gensecaihq/pfsense-mcp-server — Claude Code skill discovered by cue"
description: "pfSense MCP Server enables security administrators to manage their pfSense firewalls using natural language through AI assistants like Claude Desktop. Simply as"
layout: page
updated: 2026-08-08
...
**★ 84** · exceptional (score 13.4) · Python · claude, genai, hacktoberfest, mcp, mcp-server
...
- 🏷️ Tags: claude, genai, hacktoberfest, mcp, mcp-server, mcp-servers, pfsense, pfsense-firewall
...
cue skills add gensecaihq/pfsense-mcp-server --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/gensecaihq/pfsense-mcp-server)
