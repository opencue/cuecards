---
title: "rogue-dev-studio/rogue-comfyui-mcp — Claude Code skill discovered by cue"
description: "Status: partial - not auto-wired (-Mcp all skips this package)."
layout: page
updated: 2026-09-24
tags: [claude-code, skill, core]
---

# ✨ [rogue-dev-studio/rogue-comfyui-mcp](https://github.com/rogue-dev-studio/rogue-comfyui-mcp)

**★ 0** · strong (score 6) · comfyui, design-tools, mcp-server, partial, rogue-market-mcp
...
- 🏷️ Tags: comfyui, design-tools, mcp-server, partial, rogue-market-mcp
...
cue skills add rogue-dev-studio/rogue-comfyui-mcp --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/rogue-dev-studio/rogue-comfyui-mcp)
