---
title: "rogue-dev-studio/rogue-golang-skill — Claude Code skill discovered by cue"
description: "Go development environment. Use when the project needs this capability or the user / team manifest asks for it. Use for specialized `golang` work when listed in"
layout: page
updated: 2026-09-24
tags: [claude-code, skill, core]
---

# 💎 [rogue-dev-studio/rogue-golang-skill](https://github.com/rogue-dev-studio/rogue-golang-skill)

**★ 0** · exceptional (score 9) · ai-agent-skill, developer-tools, golang, rogue-market-skills
...
- 🏷️ Tags: ai-agent-skill, developer-tools, golang, rogue-market-skills
...
cue skills add rogue-dev-studio/rogue-golang-skill --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/rogue-dev-studio/rogue-golang-skill)
