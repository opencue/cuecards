---
title: "braydos-h/NetAttackAi — Claude Code skill discovered by cue"
...
**★ 2** · exceptional (score 8) · Python · agent, ai, bug-bounty, cybersecurity, mcp-server
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/braydos-h/NetAttackAi)
