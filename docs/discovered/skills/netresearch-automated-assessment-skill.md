...
**★ 2** · strong (score 5.4) · Shell · ai-agent-skill, assessment, automation, checkpoints, code-quality
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/netresearch/automated-assessment-skill)
