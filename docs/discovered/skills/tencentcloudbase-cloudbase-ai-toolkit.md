---
title: "TencentCloudBase/CloudBase-AI-Toolkit — Claude Code skill discovered by cue"
...
**★ 1103** · exceptional (score 19.5) · TypeScript · agent-skills, ai, aicoding, claude-code, cloudbase
...
- 🏷️ Tags: agent-skills, ai, aicoding, claude-code, cloudbase, cursor, database, dsh-plugin, mcp, mcp-server, miniprogram, postgresql, supabase, tencent, vibe-coding, web
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/TencentCloudBase/CloudBase-AI-Toolkit)
