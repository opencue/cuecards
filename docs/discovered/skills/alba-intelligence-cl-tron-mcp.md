---
title: "Alba-Intelligence/cl-tron-mcp — Claude Code skill discovered by cue"
description: "A Model Context Protocol (MCP) server for SBCL and ECL Common Lisp that enables deep debugging, introspection, profiling, and hot code reloading for SBCL applic"
layout: page
updated: 2026-07-04
tags: [claude-code, skill, core]
---

# 💎 [Alba-Intelligence/cl-tron-mcp](https://github.com/Alba-Intelligence/cl-tron-mcp)

**★ 7** · exceptional (score 9.7) · Common Lisp · common-lisp, embeddable-common-lisp, http-mcp, mcp, mcp-server
...
- 🏷️ Tags: common-lisp, embeddable-common-lisp, http-mcp, mcp, mcp-server, sbcl, stdio-mcp
...
cue skills add Alba-Intelligence/cl-tron-mcp --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/Alba-Intelligence/cl-tron-mcp)
