---
title: "gnodux/adb-link — Claude Code skill discovered by cue"
description: "An MCP server that connects to multiple databases. Supports access control and dynamic SQL query tool registration and invocation."
layout: page
updated: 2026-06-08
...
**★ 0** · strong (score 6) · Go · agent, ai-tools, data-analysis, database-gateway, go
...
- 🏷️ Tags: agent, ai-tools, data-analysis, database-gateway, go, mcp, mcp-server
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/gnodux/adb-link)
