---
title: "apidog/apidog-cli-skills — Claude Code skill discovered by cue"
description: "AI Agent Skills for Apidog CLI, helping agents manage API projects, automated tests and CI workflows."
layout: page
updated: 2026-07-09
tags: [claude-code, skill, core]
---

# ✨ [apidog/apidog-cli-skills](https://github.com/apidog/apidog-cli-skills)

**★ 1** · strong (score 6.3) · agent-skills, api-management, api-testing, apidog, apidog-cli
...
- 🏷️ Tags: agent-skills, api-management, api-testing, apidog, apidog-cli, claude-code-skill, skills-sh
...
cue skills add apidog/apidog-cli-skills --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/apidog/apidog-cli-skills)
