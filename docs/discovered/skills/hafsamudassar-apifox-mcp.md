---
title: "HafsaMudassar/apifox-mcp — Claude Code skill discovered by cue"
description: "🚀 Manage Apifox projects effortlessly using natural language commands with the MCP server for seamless integration with LLMs like Claude."
layout: page
updated: 2026-06-10
...
**★ 0** · strong (score 7.5) · Python · ai-tools, api-documentation, apifox, docker, java
...
- 🏷️ Tags: ai-tools, api-documentation, apifox, docker, java, mcp, mcp-server, model-context-protocol
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/HafsaMudassar/apifox-mcp)
