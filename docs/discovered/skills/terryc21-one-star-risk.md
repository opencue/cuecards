---
title: "Terryc21/one-star-risk — Claude Code skill discovered by cue"
description: "A Claude Code skill: re-score audit findings for App Store one-star-review risk. A judgment lens with named, overridable triggers and a pluggable review-groundi"
layout: page
updated: 2026-08-28
tags: [claude-code, skill, core]
---

# 💎 [Terryc21/one-star-risk](https://github.com/Terryc21/one-star-risk)

**★ 1** · exceptional (score 8.3) · ai-tools, app-store, aso, claude-code, claude-code-skill
...
- 🏷️ Tags: ai-tools, app-store, aso, claude-code, claude-code-skill, code-audit, release-management, swift, swiftui
...
cue skills add Terryc21/one-star-risk --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/Terryc21/one-star-risk)
