---
title: "CSOAI-ORG/time-tracker-ai-mcp — Claude Code skill discovered by cue"
...
# ✨ [CSOAI-ORG/time-tracker-ai-mcp](https://github.com/CSOAI-ORG/time-tracker-ai-mcp)
...
cue skills add CSOAI-ORG/time-tracker-ai-mcp --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/CSOAI-ORG/time-tracker-ai-mcp)
