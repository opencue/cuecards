...
**★ 1** · strong (score 7.8) · Shell · ai-agents, ai-coding, auto-approve, automation, bash
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/vxctorrdrgzzz/codex-yolo)
