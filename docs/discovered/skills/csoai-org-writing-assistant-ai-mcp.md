---
title: "CSOAI-ORG/writing-assistant-ai-mcp — Claude Code skill discovered by cue"
description: "Content writing toolkit: headline generation, readability scoring, tone analysis, outline building, and plagiarism similarity checking. By MEOK AI Labs."
layout: page
updated: 2026-06-13
tags: [claude-code, skill, core]
---

# ✨ [CSOAI-ORG/writing-assistant-ai-mcp](https://github.com/CSOAI-ORG/writing-assistant-ai-mcp)

**★ 0** · strong (score 6) · Python · ai-agents, ai-governance, claude, mcp, mcp-server
...
- 🏷️ Tags: ai-agents, ai-governance, claude, mcp, mcp-server, meok-ai-labs, model-context-protocol
...
cue skills add CSOAI-ORG/writing-assistant-ai-mcp --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/CSOAI-ORG/writing-assistant-ai-mcp)
