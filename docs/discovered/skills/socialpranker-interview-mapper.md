---
title: "Socialpranker/interview-mapper — Claude Code skill discovered by cue"
description: "Evidence-grounded interview analysis skill for Claude — verbatim-checked quotes, reliability council, cross-interview insights. RU + EN."
layout: page
updated: 2026-07-05
...
**★ 0** · strong (score 6) · Python · claude-skill, custdev, interview-analysis, jtbd, llm
...
- 🏷️ Tags: claude-skill, custdev, interview-analysis, jtbd, llm, qualitative-research
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/Socialpranker/interview-mapper)
