---
title: "rogue-dev-studio/rogue-chrome-devtools-mcp — Claude Code skill discovered by cue"
description: "Rogue Chrome DevTools MCP - inspect and debug pages from agents"
layout: page
updated: 2026-09-24
tags: [claude-code, skill, core]
---

# ✨ [rogue-dev-studio/rogue-chrome-devtools-mcp](https://github.com/rogue-dev-studio/rogue-chrome-devtools-mcp)

**★ 0** · strong (score 6) · browser-automation, cdp, chrome-devtools, chromium, debugging
...
- 🏷️ Tags: browser-automation, cdp, chrome-devtools, chromium, debugging, mcp-server, rogue-market-mcp
...
cue skills add rogue-dev-studio/rogue-chrome-devtools-mcp --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/rogue-dev-studio/rogue-chrome-devtools-mcp)
