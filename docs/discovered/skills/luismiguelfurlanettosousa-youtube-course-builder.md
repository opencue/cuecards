...
**★ 1** · exceptional (score 8.3) · agent-skills, anthropic, claude-code, claude-skill, curriculum
...
[video](../video.md), [research](../research.md)
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/LuisMIguelFurlanettoSousa/youtube-course-builder)
