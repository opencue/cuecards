---
title: "PCIRCLE-AI/toonify-mcp — Claude Code skill discovered by cue"
description: "Context compression plugin for Claude Code. Automatically trims large tool output—JSON, YAML, stack traces, and logs—before it enters the context window."
layout: page
updated: 2026-08-12
tags: [claude-code, skill, core]
---

# 💎 [PCIRCLE-AI/toonify-mcp](https://github.com/PCIRCLE-AI/toonify-mcp)

**★ 64** · exceptional (score 16.6) · TypeScript · claude-code, claude-code-plugin, context-compression, context-window, developer-tooling
...
- 🏷️ Tags: claude-code, claude-code-plugin, context-compression, context-window, developer-tooling, mcp-server, model-context-protocol, token-optimization, toon-format
...
cue skills add PCIRCLE-AI/toonify-mcp --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/PCIRCLE-AI/toonify-mcp)
