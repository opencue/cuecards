...
**★ 133** · exceptional (score 17.9) · Shell · agent-skill, agent-skills, ai-agents, claude-code, claude-code-plugin
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/kharmanskyi/open-steps)
