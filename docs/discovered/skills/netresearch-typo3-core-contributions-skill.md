...
**★ 1** · exceptional (score 10.3) · Shell · agent-skills, ai-agent, claude-code-skill, contribution, gerrit
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/netresearch/typo3-core-contributions-skill)
