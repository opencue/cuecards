---
title: "pipeworx-io/mcp-gnomad — Claude Code skill discovered by cue"
description: "Broad Institute gnomAD genomic variant database (GraphQL)"
layout: page
updated: 2026-08-04
...
**★ 0** · strong (score 6) · TypeScript · gnomad, mcp, mcp-server, model-context-protocol, pipeworx
...
- 🏷️ Tags: gnomad, mcp, mcp-server, model-context-protocol, pipeworx
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/pipeworx-io/mcp-gnomad)
