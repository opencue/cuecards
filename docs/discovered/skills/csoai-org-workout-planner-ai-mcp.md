---
title: "CSOAI-ORG/workout-planner-ai-mcp — Claude Code skill discovered by cue"
...
# ✨ [CSOAI-ORG/workout-planner-ai-mcp](https://github.com/CSOAI-ORG/workout-planner-ai-mcp)
...
cue skills add CSOAI-ORG/workout-planner-ai-mcp --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/CSOAI-ORG/workout-planner-ai-mcp)
