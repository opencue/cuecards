---
title: "mrreviewai/affiliate-marketer-skill — Claude Code skill discovered by cue"
description: "Claude Code skill from mrreviewai/affiliate-marketer-skill"
layout: page
updated: 2026-06-16
tags: [claude-code, skill, core]
---

# 💎 [mrreviewai/affiliate-marketer-skill](https://github.com/mrreviewai/affiliate-marketer-skill)

**★ 0** · exceptional (score 12.5) · affiliate-marketing, affiliate-programs, agent-skill, ai-tools, claude-skill
...
- 🏷️ Tags: affiliate-marketing, affiliate-programs, agent-skill, ai-tools, claude-skill
...
cue skills add mrreviewai/affiliate-marketer-skill --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/mrreviewai/affiliate-marketer-skill)
