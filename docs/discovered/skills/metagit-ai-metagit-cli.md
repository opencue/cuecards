---
title: "metagit-ai/metagit-cli — Claude Code skill discovered by cue"
description: "Situational awareness across Git repositories."
layout: page
updated: 2026-06-17
tags: [claude-code, skill, core]
---

# ✨ [metagit-ai/metagit-cli](https://github.com/metagit-ai/metagit-cli)

**★ 1** · strong (score 7.8) · Python · agent-skills, cli, git, mcp-server, metadata
...
- 🏷️ Tags: agent-skills, cli, git, mcp-server, metadata, project-management, python, situational-awareness, skill
...
cue skills add metagit-ai/metagit-cli --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/metagit-ai/metagit-cli)
