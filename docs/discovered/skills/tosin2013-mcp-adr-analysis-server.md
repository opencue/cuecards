---
title: "tosin2013/mcp-adr-analysis-server — Claude Code skill discovered by cue"
...
**★ 29** · exceptional (score 10.7) · TypeScript · adr, ai-agents, architectural-decision-records, architecture, claude
...
- 🏷️ Tags: adr, ai-agents, architectural-decision-records, architecture, claude, cursor, mcp-server, typescript
...
cue skills add tosin2013/mcp-adr-analysis-server --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/tosin2013/mcp-adr-analysis-server)
