---
title: "rogue-dev-studio/rogue-illustrator-mcp — Claude Code skill discovered by cue"
description: "Rogue MCP bridge for Adobe Illustrator - artboards, vectors, and exports for agents"
layout: page
updated: 2026-09-24
tags: [claude-code, skill, core]
---

# ✨ [rogue-dev-studio/rogue-illustrator-mcp](https://github.com/rogue-dev-studio/rogue-illustrator-mcp)

**★ 0** · strong (score 6) · adobe, artboard, design-tools, exports, illustrator
...
- 🏷️ Tags: adobe, artboard, design-tools, exports, illustrator, mcp-server, rogue-market-mcp, vector
...
cue skills add rogue-dev-studio/rogue-illustrator-mcp --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/rogue-dev-studio/rogue-illustrator-mcp)
