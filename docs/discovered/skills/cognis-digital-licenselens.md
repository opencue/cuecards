---
title: "cognis-digital/licenselens — Claude Code skill discovered by cue"
description: "Dependency license + SBOM gate, developer-CLI first"
layout: page
updated: 2026-06-23
...
**★ 0** · strong (score 6) · Python · automation, cli, cloud, cognis, cognis-digital
...
- 🏷️ Tags: automation, cli, cloud, cognis, cognis-digital, cognis-neural-suite, developer-tools, devops, devtools, licenselens, mcp-server, productivity, python, sbom, security, self-hosted, vulnerability-scanner
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/cognis-digital/licenselens)
