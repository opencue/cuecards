---
title: "AnsirStudio/self-distiller — Claude Code skill discovered by cue"
description: "Distill scattered material into a structured, reusable markdown identity layer + a compact profile card for any agent. Inspired by Karpathy's LLM Wiki & the hon"
layout: page
updated: 2026-06-17
...
**★ 0** · exceptional (score 13.5) · agent-skill, claude-skill, distillation, identity, llm
...
- 🏷️ Tags: agent-skill, claude-skill, distillation, identity, llm, markdown, memory, personal-knowledge, user-profile
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/AnsirStudio/self-distiller)
