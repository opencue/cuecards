...
cue skills add Naberator/editor-guide --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/Naberator/editor-guide)
