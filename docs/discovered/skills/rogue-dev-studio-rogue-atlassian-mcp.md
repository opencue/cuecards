---
title: "rogue-dev-studio/rogue-atlassian-mcp — Claude Code skill discovered by cue"
description: "Rogue Atlassian MCP - remote Jira/Confluence tools for agents"
layout: page
updated: 2026-09-24
tags: [claude-code, skill, core]
---

# ✨ [rogue-dev-studio/rogue-atlassian-mcp](https://github.com/rogue-dev-studio/rogue-atlassian-mcp)

**★ 0** · strong (score 6) · atlassian, collaboration-tools, confluence, jira, mcp-server
...
- 🏷️ Tags: atlassian, collaboration-tools, confluence, jira, mcp-server, rogue-market-mcp, sse
...
cue skills add rogue-dev-studio/rogue-atlassian-mcp --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/rogue-dev-studio/rogue-atlassian-mcp)
