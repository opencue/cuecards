...
# ✨ [AURORA-NEURO/aurora-agent](https://github.com/AURORA-NEURO/aurora-agent)

**★ 1** · strong (score 5.3) · Rust · claude, claude-plugin, decision-support, mcp, mcp-server
...
cue skills add AURORA-NEURO/aurora-agent --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/AURORA-NEURO/aurora-agent)
