---
title: "rogue-dev-studio/rogue-imagemagick-skill — Claude Code skill discovered by cue"
description: "ImageMagick processing MCP server. Use when the project needs this capability or the user / team manifest asks for it. Use for specialized `imagemagick` work wh"
layout: page
updated: 2026-09-24
...
**★ 0** · exceptional (score 8) · ai-agent-skill, design-tools, imagemagick, rogue-market-skills
...
- 🏷️ Tags: ai-agent-skill, design-tools, imagemagick, rogue-market-skills
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/rogue-dev-studio/rogue-imagemagick-skill)
