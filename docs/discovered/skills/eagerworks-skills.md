---
title: "eagerworks/skills — Claude Code skill discovered by cue"
description: "A collection of portable agent skills by Eagerworks — install via the skills.sh CLI for Claude Code, Cursor, Copilot, Codex, Amp, and more."
layout: page
updated: 2026-08-28
tags: [claude-code, skill, core]
---

# 💎 [eagerworks/skills](https://github.com/eagerworks/skills)

**★ 1** · exceptional (score 8.3) · Python · agent-skills, ai-agents, claude-code, claude-skill, cursor
...
- 🏷️ Tags: agent-skills, ai-agents, claude-code, claude-skill, cursor, kamal, skills, skills-sh
...
cue skills add eagerworks/skills --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/eagerworks/skills)
