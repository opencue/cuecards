---
title: "pipeworx-io/mcp-geonet-nz — Claude Code skill discovered by cue"
description: "GeoNet New Zealand MCP."
layout: page
updated: 2026-08-04
tags: [claude-code, skill, core]
---

# ✨ [pipeworx-io/mcp-geonet-nz](https://github.com/pipeworx-io/mcp-geonet-nz)

**★ 0** · strong (score 5) · TypeScript · geonet-nz, mcp, mcp-server, model-context-protocol, pipeworx
...
- 🏷️ Tags: geonet-nz, mcp, mcp-server, model-context-protocol, pipeworx
...
cue skills add pipeworx-io/mcp-geonet-nz --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/pipeworx-io/mcp-geonet-nz)
