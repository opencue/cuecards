...
# 💎 [oxHive/hivemind](https://github.com/oxHive/hivemind)

**★ 2** · exceptional (score 10) · Rust · ai, ai-agent, claude-code, cli, codex
...
cue skills add oxHive/hivemind --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/oxHive/hivemind)
