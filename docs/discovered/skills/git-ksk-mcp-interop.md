---
title: "git-ksk/mcp-interop — Claude Code skill discovered by cue"
description: "Live interoperability testing for Remote MCP servers across real MCP clients."
layout: page
updated: 2026-08-10
tags: [claude-code, skill, core]
---

# ✨ [git-ksk/mcp-interop](https://github.com/git-ksk/mcp-interop)

**★ 0** · strong (score 6) · Go · cli, developer-tools, interoperability, mcp, mcp-server
...
- 🏷️ Tags: cli, developer-tools, interoperability, mcp, mcp-server, model-context-protocol
...
cue skills add git-ksk/mcp-interop --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/git-ksk/mcp-interop)
