...
cue skills add waltercaregivers-app/magdil-rosh --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/waltercaregivers-app/magdil-rosh)
