...
# 💎 [iamsocool24/dbt-core-mcp](https://github.com/iamsocool24/dbt-core-mcp)

**★ 3** · exceptional (score 8.2) · Python · ai, analytics, dbt, dbt-core, developer-tools
...
cue skills add iamsocool24/dbt-core-mcp --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/iamsocool24/dbt-core-mcp)
