...
**★ 9** · exceptional (score 10.4) · tags: ai-agent-skill, china, claude-code, construction, cost-estimation
...
**★ 0** · exceptional (score 9.6) · tags: ai-agent, ai-agent-skill, claude-code, openclaw, prompt-engineering
