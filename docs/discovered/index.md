...
> Last updated: 2026-09-06 · refreshed nightly via GitHub Code Search.

## Browse by profile

| Profile | Skills | Sample |
|---|---|---|
| [**core**](./core.md) | 76 | `ZeroSlop`, `storybloq`, `trace-mcp` |
| [**backend**](./backend.md) | 7 | `mneme`, `ContextEngine`, `adaptive-llm-gateway` |
...
| [**cybersecurity**](./cybersecurity.md) | 3 | `Claude-OSINT`, `sanctuary-framework`, `rust-intel` |
| [**creative-media**](./creative-media.md) | 2 | `archify`, `redesigned-pancake` |
| [**research**](./research.md) | 2 | `popper-scope`, `skillassay` |
| [**docs-writer**](./docs-writer.md) | 1 | `god-of-the-void` |
| [**niche**](./niche.md) | 1 | `patent-compose-skill` |
