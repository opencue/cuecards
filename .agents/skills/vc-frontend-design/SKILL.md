...
1. **Analyze** with Codex's built-in multimodal vision - extract colors, fonts, spacing, effects
...
**Assets**: Generate images with Codex's built-in multimodal vision, process with imagemagick CLI or browser Canvas API
