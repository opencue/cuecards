---
name: "source-command-generate-llms"
...
# source-command-generate-llms

Use this skill when the user asks to run the migrated source command `generate-llms`.
