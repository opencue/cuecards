...
**MUST-3, Respect all 15 adapters equally.** Codex, codex,
...
(claimed Codex stripped them, it does not), (b) Codex
...
We shipped inheritEnvKeys because an LLM said Codex strips env vars from child processes, it does not.
