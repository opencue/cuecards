...
`;
  ...
  md += `> ${gems.length} community-built skills curated by [cue](https://github.com/opencue/cue) for the **${profile}** profile.\n`;
...
> **${totalGems} hidden-gem skills** discovered by [cue](https://github.com/opencue/cue) across **${byProfile.size} profiles**.
...
<p><strong>${totalGems} hidden-gem skills</strong> discovered by <a href="https://github.com/opencue/cue">cue</a> across <strong>${byProfile.size} profiles</strong>.</p>
...
<p><a href="https://github.com/opencue/cue">github.com/opencue/cue</a></p>
</body></html>
`;
}
...
<p>${gems.length} skills discovered by <a href="https://github.com/opencue/cue">cue</a>. Last updated ${updated.split("T")[0]}.</p>
${cards}
</body></html>
`;
}
...
<hr>
<p><small>This page was auto-generated by <a href="https://github.com/opencue/cue">cue</a>. Repo authors can opt out by adding <code>&lt;!-- cue: ignore --&gt;</code> to their README.</small></p>
</body></html>
`;
}
...
<p align="center">
  <a href="https://github.com/opencue/cue">
...
interface NotifyLog {
  ...
  // Daily digest discussion posts in opencue/cue, keyed by YYYY-MM-DD.
...
// ---------------------------------------------------------------------------
// Daily digest discussion (in opencue/cue) — lower-pressure analog to --notify
// ---------------------------------------------------------------------------

const DIGEST_REPO = process.env.CUE_DIGEST_REPO ?? "opencue/cue";
...
function buildDigestBody(gems: GemRepo[], date: string): string {
  ...
  return `> Daily digest from [\`cue discover\`](https://github.com/opencue/cue) — repos newly indexed on **${date}**, grouped by profile.
...
${cards.map((c, i) => {
  ...
  <text class="footer" x="${W - padX}" y="${H - 14}" text-anchor="end">github.com/opencue/cue</text>
</svg>`;
}
...
[**cue**](https://github.com/opencue/cue) scans GitHub for high-quality skill repos and routes them to per-profile bundles for Claude Code & Codex users. \`${gem.full_name}\` cleared the discovery threshold (score **${gem.gem_score}**, tier **${t.tier}**) and is now auto-loaded for everyone on the **\`${profile}\`** profile.
...
[Full scoring rubric →](https://github.com/opencue/cue/blob/main/src/commands/discover.ts)
...
| [\`docs/discovered.md\`](https://github.com/opencue/cue/blob/main/docs/discovered.md) | ✅ Indexed |
| GitHub backlink traffic | ✅ Active |

## Optional: README badge

<p align="center">
  <a href="https://github.com/opencue/cue"><img src="${readmeBadge}" alt="cue hidden gem"></a>
</p>

\`\`\`markdown
[![cue hidden gem](${readmeBadge})](https://github.com/opencue/cue)
\`\`\`

---

<sub>Opened by <a href="https://github.com/opencue/cue"><code>cue discover install --notify</code></a>. One issue per repo, ever. To opt out, close this issue or <a href="https://github.com/opencue/cue/issues/new">file an issue against cue</a>.</sub>`;
...
async function cmdInstall(opts: { profile?: string; minScore: number; minQuality: number; dryRun: boolean; all: boolean; notify: boolean; digest: boolean }): Promise<number> {
  ...
  // Daily digest discussion in opencue/cue — covers everything we just touched,
